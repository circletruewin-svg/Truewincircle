...
const Table = () => {
  ...
  return (
    <div className="p-6">
      ...
      {/* Recovery/Emergency buttons hidden — they broke user
          winningMoney math when users had partially withdrawn wins
          (Force revert floored debit at 0, then Re-settle credited
          full amount → over-credit). Delete result already reverses
          just that session cleanly. Fix affected users manually
          via All Users → Adjust Wallet (Winning money → Debit). */}
